CREATE TABLE IF NOT EXISTS `wp_comments` (
  ...
  `comment_type` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `wp_comments` VALUES ('1', '1', 'A WordPress Commenter', 'wapuu@wordpress.example', 'https://wordpress.org/', '', '2018-01-04 13:19:51', '2018-01-04 13:19:51', 'Hi, this is a comment.\nTo get started with moderating, editing, and deleting comments, please visit the Comments screen in the dashboard.\nCommenter avatars come from <a href="https://gravatar.com">Gravatar</a>.', '0', '1', '', '', '0', '0');
# --------------------------------------------------------
