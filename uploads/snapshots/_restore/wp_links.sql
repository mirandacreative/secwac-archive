CREATE TABLE IF NOT EXISTS `wp_links` (
  ...
  `link_target` varchar(25) COLLATE utf8mb4_unicode_ci NOT NULL,
  `link_description` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `link_visible` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL,
  `link_owner` bigint(20) unsigned NOT NULL DEFAULT '1',
  `link_rating` int(11) NOT NULL DEFAULT '0',
  `link_updated` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
  `link_rel` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `link_notes` mediumtext COLLATE utf8mb4_unicode_ci NOT NULL,
  `link_rss` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`link_id`),
